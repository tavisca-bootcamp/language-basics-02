    ...
    public static class Program
    {
        ...
        public static string GetCurrentTime(string[] exactPostTime, string[] showPostTime)
        {
            ...
            for (int i = 0; i < exactPostTime.Length; i++)
            {
                ...
                string[] humanMsg = showPostTime[i].Split(" ");
                if (string.Compare(humanMsg[1], "seconds") == 0)
                {
                    prev = exactPostTime[i];
                    seconds = seconds + 59;
                ...
                else if (string.Compare(humanMsg[1], "minutes") == 0)
                {
                    minutes = minutes + Int32.Parse(humanMsg[0]);
                    if (minutes % 60 != minutes)
                    {
                        minutes = minutes % 60;
                        hours++;
                ...
                {
                    hours = hours + Int32.Parse(humanMsg[0]);
                    hours = hours % 24;
                    string h = hours.ToString(), m = minutes.ToString(), s = seconds.ToString();
                    if (hours <= 9)
                        h = "0" + hours.ToString();
                ...
                if (string.Compare(min, prev) == -1)
                    min = prev;
                if (string.Compare(max, next) == 1)
                    max = next;
            }
