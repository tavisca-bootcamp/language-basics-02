...
namespace Tavisca.Bootcamp.LanguageBasics.Exercise1
{
    public static class Program
    {
        ...
        public static string GetCurrentTime(string[] exactPostTime, string[] showPostTime)
        {
            ...
            ConvertTimeToInt(exactPostTime, len, time);
            CalculateTime(showPostTime, time, calculatedTimes);
        ...
        private static void CalculateTime(string[] showPostTime, int[,] time, string[] calculatedTimes)
        {
            int i;
            string hh, mm, ss;
        ...
        private static void ConvertTimeToInt(string[] exactPostTime, int len, int[,] time)
        {
            int i;
            for (i = 0; i < len; i++)
            {
